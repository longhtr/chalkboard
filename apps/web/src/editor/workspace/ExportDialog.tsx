    ...
    >
      ...
      >
        ...
        <div className="export-dialog__body">
          ...
          <fieldset>
            <legend>Area</legend>
            <div className="export-option-row export-scope-options">
              <label>
                <input
              ...
              <label
                className={canExportSelection ? '' : 'is-disabled'}
                onBlur={() => setSelectionHintVisible(false)}
                onFocus={() => setSelectionHintVisible(true)}
                onMouseEnter={() => setSelectionHintVisible(true)}
                onMouseLeave={() => setSelectionHintVisible(false)}
              >
                <input
                  aria-describedby="export-selection-help"
              ...
              <span className="sr-only" id="export-selection-help">
                {selectionHelp}
              </span>
              {selectionHintVisible ? (
                <span className="export-option-tooltip">{selectionHelp}</span>
              ) : null}
            </div>
          </fieldset>
          <fieldset>
