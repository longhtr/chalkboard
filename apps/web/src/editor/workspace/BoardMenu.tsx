...
interface BoardMenuProps {
  ...
  onOpenPublicInformation(path: PublicInformationPath): void;
  onOpenShortcuts(): void;
  onToggleFontSettings(): void;
  onToggleGrid(): void;
  onToggleGridSettings(): void;
  onToggleInformationOptions(): void;
  onToggleMenu(): void;
    ...
    <div className="workspace-top-left">
      ...
      {menuOpen ? (
        <div className="board-menu">
          ...
          >
            <Icon name="equation" />
            <span>Math / LaTeX cheatsheet</span>
          </button>
          <div className="board-menu-submenu">
            <button
              className={
                informationOptionsOpen ? 'menu-item is-open' : 'menu-item'
              }
              type="button"
              aria-expanded={informationOptionsOpen}
              aria-haspopup="menu"
              onClick={onToggleInformationOptions}
            >
              <Icon name="info" />
            ...
            {informationOptionsOpen ? (
              <div
                className="new-board-popover information-popover"
                role="menu"
                aria-label="Public information"
              >
                {publicInformationNavigation.map(([path, label]) => (
                  <button
                    type="button"
                    role="menuitem"
                    key={path}
                    onClick={() => onOpenPublicInformation(path)}
                  >
                    <strong>{label}</strong>
                  </button>
                ))}
