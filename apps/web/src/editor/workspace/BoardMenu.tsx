/**
 * Board-level command menu for import/export, grid, font, sharing, reference,
 * and new-board actions. Hidden file inputs remain owned by the workspace.
 */
          ...
          <div className="board-menu-submenu">
            ...
            {fontSettingsOpen ? (
              ...
              >
                ...
                <div className="board-font-setting">
                  <div
                    className="board-font-options"
                    role="group"
                    aria-label="Font"
                  >
                    {(
