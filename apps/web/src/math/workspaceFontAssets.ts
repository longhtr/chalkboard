...
// Matches the adapter release recorded in `../vendor/excalifont/VERSION`.
// Bumping it changes every font URL, so a browser holding the previous faces
// refetches them instead of drawing the superseded outlines from cache.
const EXCALIFONT_ASSET_VERSION = '0.1.0';
