 ...
 */
import { isDemoAccountEmail } from '@chalkboard/shared';
          ...
          <div className="account-settings-shell">
            ...
            {isDemoAccountEmail(user.email) ? (
              <div className="account-status" role="status">
                ...
                <span>
                  Its username, email, and password are locked so every visitor
                  can continue signing in. Cloud-board features work normally.
                </span>
              </div>
            ) : (
              <AccountSettings
