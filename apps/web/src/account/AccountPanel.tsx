      ...
      >
        ...
        {session.status === 'loading' ? (
          ...
          <AccountForm
            ...
            onPasswordResetOpenChange={setPasswordResetOpen}
          ...
          <div className="account-settings-shell">
            ...
            {user.isDemo ? (
              <div className="account-status" role="status">
                <strong>This is a shared demo account.</strong>
                <span>
                  Content and sessions reset daily at 00:00 UTC. Do not add
                  personal or sensitive content.
                </span>
                <span>
                  Sharing works only between demo accounts. Invitations to and
                  from regular accounts will not open.
                </span>
              </div>
            ) : (
              <AccountSettings
