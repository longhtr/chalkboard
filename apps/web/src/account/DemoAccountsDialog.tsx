...
/** Shows intentionally public credentials and how the shared data behaves. */
  ...
  return (
    ...
    >
      <section
        ...
        aria-describedby="demo-account-info"
        onKeyDown={(event) => {
          event.stopPropagation();
      ...
      >
        ...
        <div className="account-status" id="demo-account-info">
          <strong>These are shared demo accounts.</strong>
          <span>
            Content and sessions reset daily at 00:00 UTC, and other visitors
            can see or change saved work. Do not add personal or sensitive
            content.
          </span>
          <span>
            Sharing works only between demo accounts. Invitations to and from
            regular accounts will not open.
          </span>
        </div>
