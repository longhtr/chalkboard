...
interface LocalBoardLibraryProps {
  ...
  /** Leaves a board owned by somebody else. The owner cannot leave their own. */
  onLeaveCloud(boardId: string): Promise<void>;
                          ...
                          <>
                            ...
                            <div className="local-board-library__actions">
                              ...
                              {board.role === 'owner' ? (
                                ...
                                // Somebody else's board, so the way out is to
                                // stop being a member rather than to trash a
                                // board that is not yours to remove.
                                <button
                                  type="button"
                                  disabled={busy}
                                  onClick={() =>
                                    void run(
                                      () => onLeaveCloud(board.id),
                                      `Left ${board.title}.`,
                                    )
                                  }
                                >
