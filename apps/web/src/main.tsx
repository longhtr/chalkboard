...
import { PublicInformationPage } from './public/PublicInformationPage';
import { isPublicInformationPath } from './public/publicRoutes';
...
const content =
  ...
  ) : isPublicInformationPath(window.location.pathname) ? (
    <PublicInformationPage pathname={window.location.pathname} />
  ) : (
    <App />
  );
