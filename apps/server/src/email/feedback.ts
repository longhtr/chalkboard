/** Idempotently stores minimum SES feedback metadata and applies complaint/hard-bounce suppression. */
  ...
  return {
    async process(event) {
      if (
        ...
        throw new Error('Invalid SES feedback metadata');
      }
