...
Do not commit a real `.env` file or include its values in logs, screenshots, or bug reports. External-provider failures use bounded information-preserving diagnostics rather than raw responses or hash-only records; preserve their completeness/correlation fields before remediation. See [architecture](docs/architecture.md#bounded-failure-evidence) and the [account-email operations runbook](deploy/account-email-operations.md#provider-failure-evidence-and-diagnosis).
...
The hosted application publishes [privacy](https://chalkboard.space/privacy), [terms](https://chalkboard.space/terms), [acceptable-use](https://chalkboard.space/acceptable-use), [retention](https://chalkboard.space/retention), [account-deletion](https://chalkboard.space/account-deletion), and [contact](https://chalkboard.space/contact) surfaces. Normal users can permanently delete their account and cloud data from Account settings.
